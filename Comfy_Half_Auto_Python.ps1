# 다운로드 (파일이 없을 때만)
if (-not (Test-Path "python-3.12.0-amd64.exe")) {
    curl.exe -L -o "python-3.12.0-amd64.exe" "https://www.python.org/ftp/python/3.12.0/python-3.12.0-amd64.exe"
}
...
# Python 설치
Clear-Host
Write-Host "Python을 설치해주세요..."
Start-Process -FilePath ".\python-3.12.0-amd64.exe" -Wait
