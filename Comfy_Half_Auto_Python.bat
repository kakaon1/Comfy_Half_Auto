...
echo if ^(-not ^(Test-Path "python-3.12.0-amd64.exe"^)^) {
echo     curl.exe -L -o "python-3.12.0-amd64.exe" "https://www.python.org/ftp/python/3.12.0/python-3.12.0-amd64.exe"
echo }
...
echo # Python Install
echo Clear-Host
echo Write-Host "Installing Python..."
echo Start-Process -FilePath ".\python-3.12.0-amd64.exe" -Verb RunAs -Wait
echo.
echo # Git Install
echo Clear-Host
